    ...
    <PageTemplate currentPage='Contact'>
      {success ? (
        <Alert
          ...
          info='A response will be sent to abdulsalamjubr3@gmail.com'
          type='success'
      ...
      {error ? (
        <Alert
          ...
          info='Something went wrong, Please make sure you filled it correctly and have an internet connection.'
          type='error'
          clickHandler={closeMessage}
        />
      ) : null}
            ...
            <div className='first-child'>
              ...
              <ul className='contact-info'>
                ...
                <li className='info'>
                  ...
                  <div>
                    <span>
                      Suite 83, Terrace Wing, Tafawa Belewa Square, Onikan,
                      Lagos, Nigeria.
                    </span>
                  </div>
                </li>
      ...
      <section
        id='faq'
        className='faq-section constraint'
      >
